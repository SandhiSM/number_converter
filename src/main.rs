...
impl Information {
    ...
    fn pretreatment(&mut self) {
        for character in self.number.as_str().chars() {
            if OK.iter().find(|&c| c == &character) != Some(&character) {
    ...
    fn range_check(&self) {
        if self.float {
            ...
            if self
                .number
                .parse::<u128>()
                .expect("Function `range_check` failed. (Exit code: )")
                >= u128::MAX
            {
                panic!("Function `range_check`failed. (Exit_code: )");
            }
        }
    }
...
mod tests {
    ...
    #[test]
    fn test_integer() {
        let mut instance = Information::new("10", false, false, 2, 10);
        instance.pretreatment();
        assert_eq!(instance.minus, false);
        instance.number_check();
        assert_eq!(instance.float, false);
        instance.range_check();
        instance.integer_convert_to_decimal();
        assert_eq!(instance.number, String::from("2"));
        assert_eq!(instance.integer_calculate(), vec!["2".to_string()]);
    }
    #[test]
    fn test_float() {
        let mut instance = Information::new("-10.1", false, false, 2, 10);
        instance.pretreatment();
        assert_eq!(instance.minus, true);
        instance.number_check();
        assert_eq!(instance.float, true);
        instance.range_check();
        instance.float_convert_to_decimal();
        assert_eq!(instance.number, String::from("2.5"));
        assert_eq!(
            instance.float_calculate(),
            vec!["-2".to_string(), ".".to_string(), "5".to_string()]
        );
    }
    #[test]
    fn test_other() {
        assert_eq!(input_upper("Enter a"), String::from("A"));
        assert_eq!(input_u8("Enter 8"), 8u8);
        assert_eq!(alphabet2number("8A"), vec![8u8, 10u8]);
        assert_eq!(number2alphabet(15u128), String::from("F"));
        assert_eq!(number2alphabet(3u128), String::from("3"));
        assert_eq!(
            convert_vec_to_string(vec!["A".to_string(), "B".to_string(), "1".to_string()]),
            String::from("AB1")
        );
        assert_eq!(
            decode("0b11101000b11001010b11100110b1110100"),
            String::from("test")
        );
        assert_eq!(
            help("error-code"),
